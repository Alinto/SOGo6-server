...
|Exactly one stored attendee answers to the sender, by address or by its recorded `SENT-BY`
|Rejected - `S000626`

|The message carries that attendee's `PARTSTAT`
|Rejected - `S000626`
...
|The sender is on the guest list of the row actually targeted (the detached occurrence when the reply carries a `RECURRENCE-ID` and one exists, the master otherwise)
|Rejected - `S000626`
|===
