...
ALL_SETTINGS_COL            = [COL_ID,
                               COL_SETTINGS_SYSTEM,
                               COL_SETTINGS_DOMAIN_DEFAULT]
TABLE_SETTINGS = Table(name="sogo_settings", columns=ALL_SETTINGS_COL, primary_key=COL_ID.name)
...
COL_DOMAIN_NAME          = Column(name="domain_name", data_type="str", extra_agrs={"max_len": 255}) #max lenght is 255 -> https://www.rfc-editor.org/rfc/rfc1035#section-2.3.4
...
ALL_DOMAIN_COL           = [COL_DOMAIN_NAME,
                            COL_DOMAIN_SETTINGS,
                            COL_DOMAIN_ORIGIN]
TABLE_DOMAIN = Table(name="sogo_settings_domains", columns=ALL_DOMAIN_COL, primary_key=COL_DOMAIN_NAME.name)
...
COL_RULE_NAME     = Column(name="rule_name", data_type="str", extra_agrs={"max_len": 255})
...
ALL_RULE_COL      = [COL_RULE_NAME,
                     COL_RULE_DOMAINS,
                     COL_RULE_SETTINGS]
TABLE_RULES = Table(name="sogo_settings_rules", columns=ALL_RULE_COL, primary_key=COL_RULE_NAME.name)
...
TABLE_USER = Table(name="sogo_user_profiles", columns=ALL_USER_COL, primary_key=COL_USER_UID.name)
