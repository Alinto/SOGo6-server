...
ALL_RULE_COL      = [COL_ID,
                     ...
                     COL_RULE_DOMAINS,
                     COL_RULE_SETTINGS]
TABLE_RULES = Table(name="sogo_settings_rules", columns=ALL_RULE_COL, primary_keys=(COL_ID.name, COL_RULE_NAME.name))
...
TABLE_USER = Table(name="sogo_user_profiles", columns=ALL_USER_COL, primary_keys=(COL_USER_UID.name,))
