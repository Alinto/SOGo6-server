...
def main() -> None:
    ...
    # ``Job.process``.
    large_storage: JobLargeStorage = JobLargeStorage(process_config.SOGO_P_AGENT_LARGE_STORE)
    set_agent(ClientAgent(agent, persistency, JobCanceller(agent, persistency), cache, large_storage))
