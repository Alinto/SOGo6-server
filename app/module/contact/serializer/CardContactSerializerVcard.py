...
class CardContactSerializerVcard(CardContactSerializer[str], ABC):
    ...
    abstract hooks the concrete CardContactSerializerVcard3 / CardContactSerializerVcard4 implement.
    """
