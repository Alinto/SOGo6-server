...
class CardContactDeserializerLdif(CardContactDeserializer[str]):
    ...
    @staticmethod
    def is_group(pairs: list[tuple[str, str]]) -> bool:
    ...
    def contact_from_pairs(pairs: list[tuple[str, str]]) -> CardContact:  # pylint: disable=too-many-branches
        ...
        for attr, value in pairs:
            ...
            elif CardContactDeserializerLdif._apply_address(address, name, value):
                has_address = True
            else:
