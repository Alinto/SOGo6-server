...
class CardContactSerializerDict(CardContactSerializer[dict]):
    ...
    def serialize(self, data: CardContact) -> dict[str, Any]:
        ...
        return {
            ...
            "birthday": data.birthday.isoformat() if data.birthday else data.birthday_yearless,
            "anniversary": data.anniversary.isoformat() if data.anniversary else data.anniversary_yearless,
            "geo": data.geo,
            "note": data.note,
