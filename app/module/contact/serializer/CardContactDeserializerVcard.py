...
class CardContactDeserializerVcard(CardContactDeserializer[str], ABC):
    ...
    TYPE/PREF extraction, delegated to the concrete CardContactDeserializerVcard3 / CardContactDeserializerVcard4.
