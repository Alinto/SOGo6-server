...
class ContactSourceDb(ContactSource):
    ...
    def get_contacts(
        ...
        sort_column: str = sort_by or tbl.COL_CT_DISPLAY_NAME.name
        return self._repo_contact.find_by_addressbook(self._addressbook.require_key, search, offset, limit, sort_column)
