...
class CalFreeBusyResultSerializerDict(CalFreeBusyResultSerializer[dict]):
    ...
    def _period_dict(p: CalFreeBusyPeriod) -> dict[str, Any]:
        d: dict[str, Any] = {
            "start": CalFreeBusyResultSerializerDict._fmt(p.date_start),
            "end": CalFreeBusyResultSerializerDict._fmt(p.date_end),
