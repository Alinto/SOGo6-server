...
class CalCalendarSerializerIcal(CalCalendarSerializer[str]):
    ...
    def __init__(
        self, events_serializer: CalEventsSerializerIcal, refresh_interval: timedelta | None = None,
    ) -> None:
        self._events_serializer: CalEventsSerializerIcal = events_serializer
