...
class CalCalendarDeserializerIcal(CalCalendarDeserializer[str]):
    ...
    CalEventsDeserializerIcal, which fills ``calendar.events``.
    """

    def __init__(self, events_deserializer: CalEventsDeserializerIcal) -> None:
        self._events_deserializer: CalEventsDeserializerIcal = events_deserializer
